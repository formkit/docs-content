...
- 🇧🇦 Bosnian (bs) — 🙏&nbsp;@TarikTz
- <img src="/img/catalan.png" alt="Catalan flag (Senyera)" class="inline w-[1em] mr-1"> Catalan (ca) — 🙏&nbsp;@petergithubmgw
- 🇨🇳 Chinese (zh) — 🙏&nbsp;@myleslee
...
- <img src="/img/frisian_flag.svg" alt="Frisian flag" class="inline w-[1em] mr-1"> Frisian (fy) — 🙏&nbsp;@arjendejong12
...
---
  ...
  file: [
    ...
    '_examples/locale-change-2/formkit.config.js'
  ]
---
::
...
---
  ...
  file: [
    '_examples/locale-change/locale-change.vue',
    '_examples/locale-change/formkit.config.js'
  ]
---
::
...
---
  ...
  file: [
    ...
    '_examples/locale-change-config/formkit.config.js'
  ]
---
::
