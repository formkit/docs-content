...
react-file: "_examples/generating/generating.react.jsx"
---
::
...
react-file: "_examples/schema-elements/schema-elements.react.jsx"
layout: "auto"
---
::
...
react-file: "_examples/schema-components/schema-components.react.jsx"
layout: "auto"
mode: "editor"
---
::
...
---
In order to pass concrete components via the <code>library</code> prop, it's best to :FrameworkText{vue="wrap your library with Vue’s <code>markRaw</code> signature" react="pass stable component references through the <code>library</code> prop"}.
::
...
react-file: "_examples/schema-data/schema-data.react.jsx"
layout: "auto"
---
::
...
react-file: "_examples/schema-functions/schema-functions.react.jsx"
layout: "auto"
---
::
...
react-file: "_examples/schema-dot-syntax/schema-dot-syntax.react.jsx"
layout: "auto"
---
::
...
react-file: "_examples/schema-expressions/schema-expressions.react.jsx"
layout: "auto"
---
::
...
Both `$el` and `$cmp` schema nodes can leverage an `if` property that roughly equates to :FrameworkText{vue="a <code>v-if</code> in Vue" react="conditional rendering in React"}. If the expression assigned to the `if` property is truthy, the node is rendered, otherwise it is not:

::Example
---
name: "Schema - conditional"
file: "_examples/schema-conditional/schema-conditional.vue"
react-file: "_examples/schema-conditional/schema-conditional.react.jsx"
layout: "auto"
---
::
...
---
Conditional or iterative (when using `if` or `for`) schema nodes should always include an explicit `key` prop. Without it, the rendering layer may reuse previous DOM nodes in ways that can lead to unexpected behavior, errors, and performance issues.
::
...
react-file: "_examples/schema-conditional-object/schema-conditional-object.react.jsx"
layout: "auto"
---
::
...
react-file: "_examples/schema-conditional-attrs/schema-conditional-attrs.react.jsx"
layout: "auto"
---
::
...
Both `$el` and `$cmp` schema nodes support looping. The loop syntax is similar to :FrameworkText{vue="<code>v-for</code> in Vue" react="mapping over an array in React"}. It expects an object or array to iterate over and a property to assign the current iteration value to. Optionally, you can also capture the index or property of the current iteration:
...
react-file: "_examples/schema-loops/schema-loops.react.jsx"
layout: "auto"
---
::
...
react-file: "_examples/schema-slots/schema-slots.react.jsx"
layout: "auto"
---
::
...
At times it may be necessary to pass an object of variable or unknown attributes or props to a `$cmp` or `$el`. :FrameworkText{vue="In Vue you would typically do this with <code>v-bind</code>" react="In React you would typically do this with object spread props"}. In schema land, you use the `bind` property:

::Example
---
name: "Schema - bind"
file: "_examples/schema-bind/schema-bind.vue"
react-file: "_examples/schema-bind/schema-bind.react.jsx"
layout: "auto"
---
::
...
react-file: "_examples/schema-raw/schema-raw.react.jsx"
---
::
...
react-file: "_examples/schema-formkit/schema-formkit.react.jsx"
layout: "auto"
---
::
...
react-file: "_examples/generating-sugar/generating-sugar.react.jsx"
---
::
...
react-file: "_examples/schema-get/schema-get.react.jsx"
layout: "auto"
---
::
...
react-file: "_examples/generating-form/generating-form.react.jsx"
---
::
