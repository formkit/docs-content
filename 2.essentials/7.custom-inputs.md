...
react-file: "_examples/custom-input/custom-input.react.jsx"
---
::
...
react-file: [
  "_examples/custom-input-default-config/custom-input-default-config.react.jsx",
  "_examples/custom-input-default-config/formkit.config.react.jsx"
]
---
::
...
react-file: "_examples/custom-input-plugin/custom-input-plugin.react.jsx"
---
::
...
| Code      | Pros                                                                                                                                                                                                                                                                                                                          | Cons                                                                                                                                                                                                                                                                                                                                |
| --------- | ----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | ----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| Component | <ul><li>Learning curve (you likely already know how to write components in your framework).</li><li>Framework-native authoring experience.</li><li>Slightly faster initial render.</li></ul>                                                                                                                                | <ul><li>Cannot use the <a href="/essentials/inputs#sections-schema"><code>sectionsSchema</code> prop</a> to modify structure.</li><li>Plugins cannot modify schema to change rendered output.</li><li>Framework specific.</li><li>Easy to write inputs that don’t play well with the FormKit ecosystem.</li></ul> |
| Schema    | <ul><li>Structure can be modified via the <code>sectionsSchema</code> prop (if you allow it).</li><li>Plugins can modify/change the rendered output.</li><li>Portable across supported frameworks.</li><li>Ecosystem compatibility (great for publishing your own open source inputs).</li></ul> | <ul><li>Learning curve (need to <a href="/essentials/schema">understand schemas</a>).</li><li>Slightly slower initial render.</li><li>Less mature dev tooling.</li></ul>                                                                                                                                                            |
...
---
Even if you prefer to write a custom input using a standard component, you can still use a schema in your input definition. Please read the <a href="#using-createinput-to-extend-the-base-schema">Using <code>createInput</code> to extend the base schema</a> section.
::
...
To create inputs using the base schema you can use the `createInput()` utility from :FrameworkText{vue="<code>@formkit/vue</code>" react="<code>@formkit/react</code>"}. This function accepts 3 arguments:

- (required) A schema node _or_ a framework component, which it inserts into the base schema at the `input` section (see diagram above).
...
react-file: "_examples/create-input/create-input.react.jsx"
---
::
...
react-file: "_examples/scratch-schema-input/scratch-schema-input.react.jsx"
---
::
...
---
type: "info"
label: "Custom inputs vs framework component wrappers"
---
When writing a custom FormKit input with framework components it is generally best to avoid nesting FormKit components inside the custom input itself. Custom inputs are meant to behave like regular inputs, using the FormKit <code>context</code> prop to add the behavior FormKit expects. If your real goal is to wrap an existing FormKit input with defaults or surrounding UI, prefer a normal framework component wrapper or FormKit’s <a href="/guides/export-and-restructure-inputs">input export feature</a> instead.
::
...
The equivalent in :FrameworkText{vue="a Vue component" react="a React component"}:
...
FormKit uses the `props` namespace for both purposes (see the autocomplete example below for an example of this). Props should _always_ be defined in camelCase and then consumed using :FrameworkText{vue="kebab-case in Vue templates" react="camelCase in React JSX"}. There are 2 ways to define props:
...
react-file: [
  "_examples/custom-props/custom-props.react.jsx"
]
---
::
...
react-file: [
  "_examples/custom-props-create-input/custom-props-create-input.react.jsx"
]
---
::
...
react-file: [
  "_examples/custom-props-create-input/custom-props-object-notation.react.jsx"
]
---
::
...
react-file: [
  "_examples/custom-props-create-input/custom-props-add-props.react.jsx"
]
---
::
...
---
  ...
  react-file: [
    "_examples/custom-sum/custom-sum.react.jsx",
    "_examples/custom-sum/formkit.config.react.jsx"
  ]
---
::
...
---
  ...
  react-file: "_examples/standard-text-input/standard-text-input.react.jsx"
---
::
...
react-file: [
  "_examples/autocomplete/autocomplete.react.jsx",
  "_examples/autocomplete/autocomplete-input.react.js",
  "_examples/autocomplete/formkit.config.react.jsx"
]
