...
---
  name: "Text input"
  file: "_examples/single-component/single-component.vue"
  react-file: "_examples/single-component/single-component.react.jsx"
---
::
...
---
  ...
  react-file: [
    "_examples/single-component/single-component-pro.react.jsx",
  ]
---
::
...
There are 3 ways to set the value of an input:
...
---
  name: "Value prop"
  file: "_examples/value-prop/value-prop.vue"
  react-file: "_examples/value-prop/value-prop.react.jsx"
---
::
...
---
  name: "Input v-model"
  file: "_examples/v-model/v-model.vue"
  react-file: "_examples/v-model/v-model.react.jsx"
---
::
...
---
  name: "Node input"
  file: "_examples/node-input/node-input.vue"
  react-file: "_examples/node-input/node-input.react.jsx"
---
::
...
::FrameworkOnly{framework="react"}
Parent inputs like `list`, `group`, and `form` are also able to directly set the values of any of their children. In fact, the value of a parent is just the aggregate value of its children. You can use any of the above methods (`value` prop or `node.input()`) to set the value of the children.
::

::Example
---
  name: "Parent input"
  file: "_examples/parent-input/parent-input.vue"
  react-file: "_examples/parent-input/parent-input.react.jsx"
---
::
...
---
  name: "Text input"
  file: "_examples/attributes/attributes.vue"
  react-file: "_examples/attributes/attributes.react.jsx"
  render: "html"
---
::
...
---
  ...
  file: "_examples/simple-validation/simple-validation.vue"
  react-file: "_examples/simple-validation/simple-validation.react.jsx"
---
::
...
---
  name: "Delay prop"
  file: "_examples/delay-prop/delay-prop.vue"
  react-file: "_examples/delay-prop/delay-prop.react.jsx"
---
::
...
---
  name: "Simple validation"
  file: "_examples/simple-errors/simple-errors.vue"
  react-file: "_examples/simple-errors/simple-errors.react.jsx"
---
::
...
---
  The above are framework-level events emitted by FormKit's UI bindings. <code>@formkit/core</code> also emits <a href="/essentials/architecture#core-events">its own events</a> as part of the lifecycle of <a href="/essentials/architecture#node">core nodes</a>.
::
...
---
  name: "Label slot"
  file: "_examples/label-slot/label-slot.vue"
  react-file: "_examples/label-slot/label-slot.react.jsx"
---
::
...
---
  ...
  file: "_examples/schema-overrides/schema-overrides.vue"
  react-file: "_examples/schema-overrides/schema-overrides.react.jsx"
  tabs: "html,render"
---
::
...
---
  name: "No wrappers"
  file: "_examples/schema-wrappers/schema-wrappers.vue"
  react-file: "_examples/schema-wrappers/schema-wrappers.react.jsx"
  tabs: "html,render"
---
::
...
---
  name: "No wrappers"
  file: "_examples/schema-content/schema-content.vue"
  react-file: "_examples/schema-content/schema-content.react.jsx"
---
::
