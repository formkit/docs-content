...
label: "Fastest Start"
---
The fastest way to get started is to run `npx formkit skill`. It installs the FormKit coding-agent skill, detects whether your project uses :FrameworkText{vue="Vue or Nuxt" react="React"}, and can wire project instructions for Codex or Claude Code. Other supported agents get a ready-to-paste setup snippet.
::
