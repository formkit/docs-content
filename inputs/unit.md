---
title: Unit
description: The unit input is used to create locale/currency specific parsed content for percentages, temperatures and measurements
---
...
The unit input is used to create locale/currency specific parsed content for percentages, temperatures and measurements
...
The `unit` prop is the type of unit you want to display from percentages, temperatures, measurements, etc. A full list of allowed unit types are listed below:
...
file: "_content/_examples/unit/unit-type-switcher.vue"
---
::
