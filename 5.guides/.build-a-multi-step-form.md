...
react-file: [
  "_examples/guides/multi-step-form/basic-form/example.react.jsx"
]
bp: 880
editable: true
---
...
react-file: [
  "_examples/guides/multi-step-form/form-in-steps/example.react.jsx"
]
bp: 880
editable: true
---
...
react-file: [
  "_examples/guides/multi-step-form/showing-validity/example.react.jsx",
  "_examples/guides/multi-step-form/showing-validity/useSteps.react.js",
  "_examples/guides/multi-step-form/showing-validity/utils.js",
]
bp: 880
editable: true
...
react-file: [
  "_examples/guides/multi-step-form/showing-all-state/example.react.jsx",
  "_examples/guides/multi-step-form/showing-all-state/useSteps.react.js",
  "_examples/guides/multi-step-form/showing-all-state/utils.js",
]
bp: 880
editable: true
...
We submit the form by adding :FrameworkText{vue="an <code>@submit</code> handler" react="an <code>onSubmit</code> handler"} to the `<FormKit type="form">`:
...
```jsx
<FormKit type="form" onSubmit={submitApp}> ... rest of form</FormKit>
```
::
...
So, what happens if the user is on step 3 (Application) when they submit, and there are field-level errors on a hidden step? Thankfully, so long as the nodes still exist in the DOM, FormKit is able to place these errors appropriately. This is why the examples keep hidden steps mounted instead of conditionally unmounting them — in Vue that means `v-show` instead of `v-if`, and in React it means toggling visibility instead of removing the step from the tree.
...
react-file: [
  "_examples/guides/multi-step-form/final-form/example.react.jsx",
  "_examples/guides/multi-step-form/final-form/useSteps.react.js",
  "_examples/guides/multi-step-form/final-form/utils.js"
]
bp: 880
editable: true
